                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mt-2">Register to continue to Penjualan.</p>
                                    </div>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Already have an account ? <a
                                                href="{{ route('client.login') }}" class="text-primary fw-semibold"> SignIn now
                                            </a> </p>
                                    </div>
                                </div>
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        </script> RestoHub . Crafted with <i
                                            class="mdi mdi-heart text-danger"></i> by RestoHub
                                    </p>
                                </div>
                            </div>
                        </div>
