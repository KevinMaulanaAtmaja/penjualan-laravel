            ...
            <div class="row d-flex align-items-end">
                <div class="col-md-8">
                    <div class="restaurant-detailed-header-left">
                        ...
                        <p class="text-white mb-1"><i class="icofont-location-pin"></i> 2036 2ND AVE, NEW YORK, NY 10029
                            <span class="badge badge-success">OPEN</span>
                        </p>
                        <p class="text-white mb-0"><i class="icofont-food-cart"></i> North Indian, Chinese, Fast Food,
                            South Indian
                        </p>
                    </div>
                </div>
                ...
                <div class="offer-dedicated-body-left">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-order-online" role="tabpanel"
                                        ...
                                        <div class="p-3 position-relative">
                                            <div class="list-card-body">
                                                ...
                                                <p class="text-gray time mb-0"><a
                                                        class="btn btn-link btn-sm text-black" href="#">$550
                                    ...
                                    <div
                                        ...
                                        <div class="p-3 position-relative">
                                            <div class="list-card-body">
                                                ...
                                                <p class="text-gray time mb-0"><a
                                                        class="btn btn-link btn-sm text-black" href="#">$250
                                ...
                                <div class="col-md-12">
                                    <div class="bg-white rounded border shadow-sm mb-4">
                                        <div class="gold-members p-3 border-bottom">
                                            ...
                                            <div class="media">
                                                <div class="mr-3"><i
                                                        class="icofont-ui-press text-danger food-item"></i></div>
                                        ...
                                        <div class="gold-members p-3">
                                            ...
                                            <div class="media">
                                                <div class="mr-3"><i
                                                        class="icofont-ui-press text-success food-item"></i></div>
                                                <div class="media-body">
                            ...
                            <div class="row">
                                <h5 class="mb-4 mt-3 col-md-12">Soups <small class="h6 text-black-50">8 ITEMS</small>
                                </h5>
                                <div class="col-md-12">
