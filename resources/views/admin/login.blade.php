                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="my-auto auth-content">
                                    <div class="text-center">
                                        ...
                                        <p class="mt-2 text-muted">Sign in to continue to Penjualan.</p>
                                    </div>
                                    ...
                                    {{-- <div class="mt-5 text-center">
                                        <p class="mb-0 text-muted">Don't have an account ? <a href="{{ route('admin.lo') }}"
                                ...
                                <div class="mt-4 text-center mt-md-5">
                                    <p class="mb-0">©
                                        <script>
                                            ...
                                            class="mdi mdi-heart text-danger"></i> by KevinMA
                                    </p>
                                </div>
                            </div>
                        </div>
